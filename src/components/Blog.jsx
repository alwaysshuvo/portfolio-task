  ...
  const allBlogPosts = [
    {
      ...
      excerpt: "Lorem Ipsum is simply dummy text the printing typesetting industry. Lorem Ipsum has been...",
  ...
  return (
    <section className="w-full bg-[#171B1A] py-24 px-4">
      ...
      <div className="text-center  mb-20">
        <h2 className="text-[48px]  font-bold text-white">Blog</h2>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {blogPosts.map((post) => (
            ...
            >
              ...
              {/* Content Below Image - Black Background (No Gap) */}
